        ...
        <div class="container py-xl-5 py-3">
            <div class="login-body">
                <div class="login p-4 mx-auto">
                    ...
                    <form style="border:solid black 1px" action="{{ route('AddCategory') }}" method="post">
                        @csrf
                        <div style="display: flex; flex-direction: column;">
                            <label for="categoryName">Name Of Category</label>
                            <input id="categoryName" type="text" class="mt-3" name="name" placeholder="name of category">
                        </div>
                        <button class="btn btn-success submit mt-4" type="submit">Create Category</button>
                    </form>
                </div>
            </div>
        </div>
